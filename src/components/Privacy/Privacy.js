    ...
    <>
      <main class="main main__privacy">
        ...
        <p>
          ...
          безопасности персональных данных, предпринимаемые ИП Снитко И.В. (далее
          – Оператор).
        </p>
        <p>
        ...
        <p>
          ...
          почты nice-dev@list.ru с пометкой «Отказ от уведомлений о новых
        ...
        <p>
          ...
          уведомление на адрес электронной почты Оператора nice-dev@list.ru с
        ...
        <p>
          ...
          электронный адрес Оператора nice-dev@list.ru с пометкой «Отзыв согласия
        ...
        <p>
          ...
          Интернет по адресу https://nice-dev.ru/.
        </p>
      </main>
      <ScrollUp />
    </>
