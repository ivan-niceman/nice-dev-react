            ...
            <div className="block__questions">
              <ul className="accordion" id="accordionExample">
                <li className="card accordion-item">
                  ...
                  >
                    <p className="card-body questions__paragraph">
                      ...
                      анализ, разработка структуры сайта, дизайн сайта и верстка
                      сайта по дизайн-макету.
                    </p>
                  </div>
                </li>
                <li className="card accordion-item">
                ...
                <li className="card accordion-item">
                  ...
                  >
                    <p className="card-body questions__paragraph">
                      Продающий сайт создается с учетом текущего состояния рынка
                      и запросов потребителя, и в связи с этим имеет более
                      высокую конверсию.
                    </p>
                  </div>
                </li>
